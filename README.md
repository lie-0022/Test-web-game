...
> **🌿 이 브랜치: `concept/ghost-racers` — GHOST RACERS 프로토타입**
> 일일 시드 트랙 고스트 레이싱, 비동기 멀티플레이. 코어 루프만 구현된 최소 프로토타입.
> 테스트: `npm install && npm run dev` → 화면을 눌러 좌우 조향, 중앙선에 붙어 깔끔하게 달릴수록 빠름.
